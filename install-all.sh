...
clear
echo -e "${GREEN}==================================================${NC}"
echo -e "${YELLOW}   PS UDP Custom Manager - Web Panel installed!${NC}"
echo -e "${GREEN}==================================================${NC}"
echo -e "${CYAN}Panel URL   :${NC} http://${PUB_IP}:${PANEL_PORT}"
echo -e "${CYAN}Username    :${NC} ${ADMIN_USER}"
echo -e "${CYAN}Password    :${NC} (you just set it)"
echo -e "${GREEN}==================================================${NC}"
echo -e "This panel manages the SAME Linux user accounts as the"
echo -e "existing CLI 'menu' (Adduser.sh / DelUser.sh / ChangeUser.sh)."
echo -e "You can use either the panel or the CLI menu interchangeably."
echo -e "${GREEN}==================================================${NC}"
